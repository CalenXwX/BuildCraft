...
//                .model("wire/")
        ...
        registerTag("item.pipe.buildcrafttransport.rf_wood").reg("pipe_rf_wood").locale("PipeRedstoneFluxWood");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_stone").reg("pipe_rf_stone").locale("PipeRedstoneFluxStone");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_cobblestone").reg("pipe_rf_cobblestone").locale("PipeRedstoneFluxCobblestone");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_quartz").reg("pipe_rf_quartz").locale("PipeRedstoneFluxQuartz");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_gold").reg("pipe_rf_gold").locale("PipeRedstoneFluxGold");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_sandstone").reg("pipe_rf_sandstone").locale("PipeRedstoneFluxSandstone");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_iron").reg("pipe_rf_iron").locale("PipeRedstoneFluxIron");
        ...
        registerTag("item.pipe.buildcrafttransport.rf_diamond").reg("pipe_rf_diamond").locale("PipeRedstoneFluxDiamond");
        ...
        registerTag("item.pipe.buildcrafttransport.power_diamond_wood").reg("pipe_power_diamond_wood").locale("PipePowerWoodenDiamond");
        registerTag("item.pipe.buildcrafttransport.rf_diamond_wood").reg("pipe_rf_diamond_wood").locale("PipeRedstoneFluxWoodenDiamond");
